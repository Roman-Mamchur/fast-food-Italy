...
<body id="sherah-dark-light " class="bg-white">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-2 col-md-4" style="background-color: #f5f5f5;">
                <!-- Admin Menu -->
                <!-- Logo -->
                            ...
                            <div class="container-fluid">
                                <div class="row mt-3 text-dark">
                                    <div class="col-md-9 col-6">
                                        <p style="font-size: 20px" class="menu-bar-subtaitel text-center text-primary">
                                            @php
                                    ...
                                    <div class="col-md-3 col-6">
                                        ...
                                        data-bs-target="#exampleModal">
                                            <svg width="20px" height="20px" viewBox="0 0 16 16" fill="none"
                                                ...
                                                <path d="M6.49999 0V8H9.49999V0H6.49999Z" fill="#000000"></path>
                                                <path
                                ...
                                <ul class="menu-bar__one sherah-dashboard-menu">
                                    <li>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="btn-group  w-100" style="height: 50px;">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li><a data-id="bell1" class="dropdown-item bell-1 ring-bell"
                                                                href="#">Bell
                                                                1</a>
                                                            <audio id="bell1"
                                                        ...
                                                        <li><a data-id="bell2" class="dropdown-item ring-bell"
                                                                href="#">Bell
                                                                2</a>
                                                            <audio id="bell2"
                                                        ...
                                                        <li><a data-id="bell3" class="dropdown-item ring-bell"
                                                                href="#">Bell
                                                                3</a>
                                                            <audio id="bell3"
    ...
    font-size: 12px;"
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"><span data-id="all"
                                                class="menu-bar__text w-100 btn old-order"
                                                style="background-color: #3c9887;">
                                    ...
                                    @if($admin_id == 'Admin')
                                    <li>
                                        <a href="javascript:void(0)"><span data-id="z-report"
                                        ...
                                        <div class="col-12 sherah-flex-center">
                                            ...
                                            <div class="sherah-breadcrumb ">
                                                <h2 class="sherah-breadcrumb__title text-center">
                                                    {{ \Carbon\Carbon::parse(\Carbon\Carbon::now())->format('l') }}
                                                </h2>
                                                <ul class="sherah-breadcrumb__list">
                                                    <li style="font-size: 18px;">{{ date('d-M-Y') }}</li>
                                                    <li><img width="24"
                                                            src="{{ asset('admin/img/clock-time.svg') }}"
                                                            alt="">
                                                    </li>
                                                    <li style="font-size: 18px;" id="clock">
                                                        {{ \Carbon\Carbon::now()->format('h:i A') }}</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25 order-management">
                                        <table id="sherah-table__vendor"
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-7 sherah-table__h7 text-truncate all-order-t"
                                                        style="display: none;">
                                                        Order Status
                                                    </th>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            ...
                            $('#print-invoice-report').print(); // Open the print dialog
