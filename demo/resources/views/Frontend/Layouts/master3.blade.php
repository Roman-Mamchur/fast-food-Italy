        ...
        <nav class="mobile-bottom-menu-main" >
            <ul class="mobile-bottom-menu" >
                ...
                <li>
                    ...
                    <div class="tag-count">
                       <span id="carCountM" style="color: #fff !important"> {{ session('cart') ? count(session('cart')) : 0 }}</span>
                    </div>
                    {{ __('translate.cart') }}
                </a>
                </li>
                ...
                <li>
                    ...
                    <a href="{{route('user.wishlist')}}" class="{{ Route::is('user.wishlist') ? 'active' : '' }}">
                        @else
                        <a href="javascript:;"
                        data-bs-toggle="modal" data-bs-target="#exampleModalLogin" class="{{ Route::is('user.wishlist') ? 'active' : '' }}">
                    @endif
            ...
            <li style="top: 14px;">
                ...
                @else
                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModalLogin" class="{{ Route::is('user.dashboard') ? 'active' : '' }}"> <i class="fa-solid fa-circle-user"></i>
                @endif
                {{ __('Login') }}
                </a>
                </li>
