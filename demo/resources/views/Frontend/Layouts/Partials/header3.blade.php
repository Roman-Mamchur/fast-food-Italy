            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="nav-main">
                        <div class="nav-main">
                            <div class="logo">
                                <a href="{{ route('index') }}"> <img height="80" src="{{ asset('frontend/assets/images/logo/logo-header.png') }}"
                                        alt="logo"></a>
                            </div>
                            <div class="menu">
                                <ul>
                        ...
                        <div class="nav-btn-main">
                            ...
                            @if (!Auth::user())
                                <div class="nav-login-btn-main">
                                    <a href="javascript:;"
                                    data-bs-toggle="modal" data-bs-target="#exampleModalLogin" class="main-btn-four custom-btn">{{ __('Log In') }}</a>
                                </div>
                            @endif
...
<header class="mobile-header">
    {{-- <div class="d-flex pt-3 pb-3 ml-1" style="background: #ff9a00;">
        <div class="d-flex" style="width: 35%!important">
            ...
            <div class="text">
                <a style="font-wight: 600;font-size: 14px; color: white;"
                    href="tel:{{ $section->top_ber_phone }}">{{ $section->top_ber_phone }}</a>
            </div>
        </div>
        <div class="">
            <p style="font-size: 14px; color: white; margin-top: 2px;">Opening hours: 4:00 PM to 11:00 PM</p>
        </div>
    </div> --}}
        ...
        <div class="mobile-header__container">
            <div class="p-left d-flex" style="z-index: 1;">
                ...
                <div style="text-align: center; margin-left: 30px;">
                    <a style="font-wight: 700;font-size: 15px; color: white;" href="tel:{{ $section->top_ber_phone }}"><i class="fa fa-phone"></i> {{ $section->top_ber_phone }}</a>
                    <p style="font-wight: 700;font-size: 15px; color: white; margin-top: 2px;">Opening hours: 4:00PM - 11:00PM</p>
                </div>
            </div>
...
<aside id="offcanvas-nav">
    <nav class="m-nav">
        ...
        <div class="logo">
            <a href="{{ route('index') }}">
                <img src="{{ asset('frontend/assets/images/logo/logo-header.png') }}" height="80" alt="logo">
            </a>
        </div>
        <ul class="nav-links">
            <li><a href="{{ route('index') }}">{{ __('translate.Home') }}</a></li>
