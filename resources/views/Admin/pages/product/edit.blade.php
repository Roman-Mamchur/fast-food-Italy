                                                        ...
                                                        <div class="row">
                                                            ...
                                                            {{-- <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="vedio_top_ber_description" row="5" placeholder="type here" type="text" name="vedio_top_ber_description">{{ $translate_product->vedio_top_ber_description }}</textarea>
                                                            ...
                                                            {{-- <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="vedio_buttom_description" row="5" placeholder="type here" type="text" name="vedio_buttom_description">{{ $translate_product->vedio_buttom_description }}</textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="description" row="5" placeholder="Type here" type="text" name="long_description">{{$translate_product->long_description}}</textarea>
                                                                        ...
                                                                        <table class="table table-bordered table-hover" id="dynamic_field">
                                                                            ...
                                                                            @foreach(json_decode($translate_product->size, true) as $size => $price)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="number" name="price[]" placeholder="Enter Price" class="form-control name_email" value="{{ $price }}" step="0.1" />
                                                                                    </td>
                                                                                    @if ($loop->first)
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="sherah-wc__form-input" value="{{$products->price }}" required placeholder="Type here" type="number" name="main_price" id="price" step="0.1">
                                                                </div>
                                                            </div>
                                                            {{-- <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group"> 
                                                                    ...
                                                                    <input class="sherah-wc__form-input" value="{{$products->position}}" placeholder="Type here" type="position" name="position" id="position">
                                                                </div>
                                                            </div>
                                                            {{-- <div class="col-12">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="special_instructions" row="5" placeholder="Special Instructions" type="text" name="special instructions">{{ $products->special_instructions}}</textarea>
