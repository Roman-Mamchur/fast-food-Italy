...
<body id="sherah-dark-light " class="bg-white">
    <div id="loading-spinner" style="display: none">
        <img src="{{ asset($setting->logo) }}" width="250" height="250" alt="">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-2 col-md-4" style="background-color: #28214c;">
                ...
                <div class="logo sherah-sidebar-padding">
                    <a href="#" style="height: 150px; width: 150px; margin: auto; padding: 1rem 0rem;">
                        <img class="sherah-logo__main" src="{{ asset($admin->image) }}"
                                ...
                                <ul class="menu-bar__one sherah-dashboard-menu" style="background: #28214c;">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="btn-group  w-100" style="height: 50px;">
                                                    <button class="btn btn-primary dropdown-toggle" style=""
                                                        ...
                                                        aria-expanded="false">
                                                        <img src="{{ asset('admin/img/notify.svg') }}" class="h-100"
                                                            alt="">
                                                        <i class="bi bi-arrow-down"></i>
                                                    </button>
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li><a data-id="bell1"
                                                                class="dropdown-item bell-1 bell1 ring-bell active"
                                                                href="#">Bell
                                                                1</a>
                                                            <audio id="bell1"
                                                                src="{{ asset('admin/bells/bell2.wav') }}"
                                                                preload="auto"></audio>
                                                        </li>
                                                        <li><a data-id="bell2" class="dropdown-item bell2 ring-bell"
                                                                ...
                                                                2</a>
                                                            <audio id="bell2"
                                                                src="{{ asset('admin/bells/bell3.wav') }}"
                                                                preload="auto"></audio>
                                                        </li>
                                                        <li><a data-id="bell3" class="dropdown-item bell3 ring-bell"
                                                                ...
                                                                3</a>
                                                            <audio id="bell3"
                                                                src="{{ asset('admin/bells/bell4.mp3') }}"
                                                                preload="auto"></audio>
                                                            <audio id="bell4"
                                                                src="{{ asset('admin/bells/bell.mp3') }}"
                                                                preload="auto"></audio>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"><span data-id="new"
                                                class="menu-bar__text w-100 btn  my-order" id="new-order">
                                                <span class="menu-bar__name text-white " style="">New Orders <span
                                                        id="user-count"
                                                        style="position: absolute; right: -85px; top: -25px; background: #0d6efd;color: #fff;width: 20px;height: 20px;border-radius: 50px;display: flex;align-items: center;justify-content: center;font-size: 12px;"
                                    ...
                                    {{-- <li>
                                        <a href="javascript:void(0)"><span data-id="refund"
                                                class="menu-bar__text  w-100 btn my-order"
                                                style="">
                                                <span class="menu-bar__name text-white">Refund Orders </span>
                                            </span>
                                        </a>
                                    </li> --}}
                                    ...
                                    @if ($admin_id == 'Admin')
                                        ...
                                        {{-- <li>
                                        <a href="javascript:void(0)"><span data-id="x-report"
                                                class="menu-bar__text w-100 btn btn-report"
                                                style="background-color: #57c3fe; cursor: pointer;">
                                                <span class="menu-bar__name text-white">X Report </span>
                                            </span>
                                        </a>
                                    </li> --}}
                                        <li>
                        ...
                        <div class="col-xxl-9">
                            <div class="sherah-body">
                                ...
                                <div class="sherah-dsinner">
                                        ...
                                        <div class="col-12 sherah-flex-center">
                                            ...
                                            <div class="sherah-breadcrumb ">
                                                <h2 class="sherah-breadcrumb__title text-center">
                                                    {{ \Carbon\Carbon::now('Europe/Dublin')->format('l') }}
                                                </h2>
                                                <ul class="sherah-breadcrumb__list">
                                                    <li style="font-size: 18px;">{{ date('d-M-Y') }}
                                                        <img width="24"
                                                            src="{{ asset('admin/img/clock-time.svg') }}"
                                                            alt="">
                                                    </li>
                                                    <li style="font-size: 18px;" id="clock">
                                                        {{ \Carbon\Carbon::now('Europe/Dublin')->format('h:i A') }}
                                                    </li>
                                                </ul>
                                    ...
                                    {{-- <div class="sherah-breadcrumb">
                                        <h2 class="sherah-breadcrumb__title">Orders</h2>
                                        <ul class="sherah-breadcrumb__list">
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                $('.selected_date').on('change', function(e) {
                    ...
                    setTimeout(function() {
                        // Trigger the click event on 'All Orders' tab
                        $('.my-order[data-id="all"]').trigger('click');
                    }, 100); // Trigger tab change after 100ms delay

                    // Update the date for fetching the orders
                    setTimeout(function() {
                        // Ensure the orders for the selected date are loaded
                        getOrderOfCurrentPage1('all');
                    }, 300); // Add a slight delay for tab content to load properly
                });

                // Existing functionality for opening tabs (New, Accepted, etc.)
                $('.my-order').on('click', function(e) {
                    ...
                    $.ajax({
                        ...
                        before: function() {
                            $('.order-management .sherah-table__body').html(
                                'loading...');
                        },
                ...
                // Fetching orders for the 'All Orders' tab
    ...
    var orderID = $(this).data('id');
    var row = $(this).data('row'); // The div row to remove (data-row)
    var getDate = $('.selected_date').val(); // Get selected date for orders
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '/decline-order',  // URL for canceling an order
        data: {
            order_id: orderID,
            get_date: getDate
        },
        ...
        success: function(data) {
            ...
            // Hide the row corresponding to the order
            $('#table' + orderID).hide(); // Dynamically hide the row by using order ID

            // Switch to the New Orders tab without refreshing the page
            $('.my-order').removeClass('active');
            $('.my-order[data-id="new"]').addClass('active'); // Make the New Orders tab active
            
            // Optionally, you can scroll to the "New Orders" section if needed:
            $('html, body').animate({
                scrollTop: $("#new-order").offset().top
            }, 1000);
...
$(document).on('click', '.accept-order', function(e) {
    ...
    // AJAX request to accept the order
    $.ajax({
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        type: 'POST',
        url: '/accept-order',  // URL for accepting an order
        data: {
            order_id: orderID,
            get_date: getDate
        },
        ...
        error: function(response) {
            ...
            // // Function to refresh the "New Orders" table via AJAX
            // function fetchNewOrders() {
            //     $.ajax({
            //         url: '/new-orders', // The URL for fetching new orders
            //         type: 'POST',
            //         data: {
            //             order_type: 'new', // Filter for new orders
            //             get_date: $('.selected_date').val(), // Send the selected date to the server
            //         },
            //         success: function(response) {
            //             // Update the orders table with the new data
            //             $('.sherah-table__body').html(response.html); // Dynamically update the table
            //         },
            //         error: function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            ...
                            {{-- printWindow.document.write('<html><head><title>{{$setting->app_name}}</title></head><body>'); --}}
                            {{-- printWindow.document.write(content);  
                            {{-- printWindow.document.write('</body></html>'); --}}
                            {{-- printWindow.document.close();  // Close the document to complete the HTML structure --}}
