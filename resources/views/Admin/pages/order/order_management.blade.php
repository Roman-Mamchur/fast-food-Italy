...
<body id="sherah-dark-light " class="bg-white">
                        ...
                        <div id="sherahMenu">
                            <div class="container-fluid">
                                ...
                                <ul class="menu-bar__one sherah-dashboard-menu" style="background: #28214c;">
                                    ...
                                    @endif
                                    {{-- <li> --}}
                                    {{-- <span class="menu-bar__text w-100">
                                              <select name=""
                                                      style="padding: 0 0.5rem; cursor: pointer; text-align: center; background-color: #bd4887"
                                                      class="btn-report text-white">
                                                  <option
                                                      style="background-color: #bd4887; cursor: pointer; text-align: center;"
                                                      selected disabled>Select Report</option>
                                                  <option style="background-color: #57c3fe; cursor: pointer;"
                                                          value="z-report">Z Report</option>
                                                   <option style="background-color: #3c9887; cursor: pointer;"
                                                           value="x-report">X Report</option>
                                                   <option style="background-color: #3c9887; cursor: pointer;"
                                                           value="c-report">Complete Report</option>
                                              </select>
                                            </span>
                                </li> --}}
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            // Hiding the card after successful cancellation
            $('#' + row).closest('.cardinvoice').hide();
            
            // Delay for 1 second to simulate the process of removing the row and hiding the spinner
            setTimeout(function() {
                $('#' + row).remove();
                if (!row) {
                    audioPlayer.pause(); // Pause the audio
...
$(document).on('click', '.accept-order', function(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            // Hiding the card after successful acceptance
            setTimeout(function() {
                $('#' + row).closest('.cardinvoice').hide(); // Hide the card
                $('#loading-spinner').hide(); // Hide loading spinner
                console.log(row);
            }, 1000); // Delay of 1 second
            ...
            // Delay for 0.5 seconds before hiding the invoice content
            setTimeout(function() {
                $('.order-invoice').hide();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            ...
                            {{-- printWindow.document.write(content);  // Write the specific content to the new window --}}
