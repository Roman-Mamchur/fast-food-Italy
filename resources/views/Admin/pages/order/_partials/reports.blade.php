        ...
        <div id="print-invoice-report">
            ...
            <div class="row text-center justify-content-center my-3" style="text-align: center">
                <div class="col-md-6 col-6">
                    <a href="#"> <img height="100" style="height: 100px;" class="sherah-logo__main" src="{{asset($setting->logo)}}" alt="#"></a>
                    <h6 class="mt-2">{{$setting->app_name ?? ''}}</h6>
            ...
            <div class="row text-center justify-content-center my-2" style="text-align: center">
                ...
                <div class=" col-12 py-1 text-right">
                    <h6 style="font-weight: 400">
                        ...
                        <b>{{ $date }}</b>
                        @else
                        {{ $reportType }} Date:<b>{{\Carbon\Carbon::parse($date)->format('d-M-Y')}}</b>
                        @endif
                    </h6>
                </div>
            </div>
                ...
                <div class="col-12  ml-auto">
                    <table class="" style="margin: unset">
                        ...
                        <tr >
                            ...
                            <td style="font-size: 15px; text-align: right;">{{$creditOrders->count()}}</td>
                        </tr>
                        ...
                        <tr >
                            ...
                            <td style="font-size: 15px; text-align: right;">
                                <strong>{{ $setting->currency_icon }} {{ number_format($creditOrders->sum('total'), 2) }}</strong>
                            </td>
                        </tr>
                        ...
                        <tr >
                            ...
                            <td style="font-size: 15px; text-align: right;">{{$cashOrders->count()}}</td>
                        </tr>

                        <tr >
                            <td style="font-size: 15px;  text-align: left;   width: 200px;" class="left py-1">Cash amount</td>
                            <td style="font-size: 15px; text-align: right;">
                                <strong>{{ $setting->currency_icon }} {{ number_format($cashOrders->sum('total'), 2)}}</strong>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-12  ml-auto">
                    <table class="" style="margin: unset">
                        ...
                        <tr >
                            ...
                            <td style="font-size: 15px; text-align: right;"
                                class="right">{{$cashOrders->count() + $creditOrders->count()}}</td>
                        </tr>
                        ...
                        <tr >
                            ...
                            <td style="font-size: 15px; text-align: right;" class="right">
                                <strong>{{ $setting->currency_icon }} {{ number_format($cashOrders->sum('total') + $creditOrders->sum('total'), 2) }}</strong>
                            </td>
                        </tr>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p style="font-size: 15px;  text-align: center">Print Date: {{ \Carbon\Carbon::now()->format('d m, Y h:i A') }}</p>
                </div>
            </div>
