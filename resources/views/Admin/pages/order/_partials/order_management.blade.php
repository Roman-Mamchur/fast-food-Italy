                                    ...
                                    @if ($admin_id == 'Admin')
                                        ...
                                        <li>
                                            ...
                                            <a href="javascript:void(0)" class="date-range"
                                                style="padding: 0;     margin: 4px 5px;     width: 94%; border: none;"><span id="custom-report" data-id="custom-report"
...
<div class="active text-center" id="currentPage1">New Orders</div>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="sherah-breadcrumb">
        ...
        $(document).ready(function() {
            ...
            $('.my-order').on('click', function(e) {
                ...
                if ($(this).data('id') == 'new') {
                    ...
                    $('#currentPage1').text('Accept Order');
