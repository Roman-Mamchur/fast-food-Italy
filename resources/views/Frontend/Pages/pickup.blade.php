...
@section('content')
                        ...
                        <div class="col-lg-6 col-md-6 ">
                                ...
                                <div class="delivery-from">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="delivery-from-item col-md-6">
                                            <label for="delevery_day" class="form-label">{{ __('translate.Select Day') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="date" name="delevery_day" value="{{ $minDate }}"
                                                class="form-control" id="delevery_day" required min="{{ $minDate }}">
                                        </div>

                                        <div class="delivery-from-item col-md-6">
                                            <label for="delevery_time"
                                                class="form-label">{{ __('translate.Select Time Schedule') }} <span
                            ...
                            <div class="delivery-from">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="sign-up-from-inner">
                                            <label for="name" class="form-label">{{ __('translate.Name') }}<span
                                                    class="text-danger">*</span></label>
                                ...
                                {{-- <div class="delivery-text pb-3 text-center mt-5">
                                    <h4>{{ __('Carving More? Just Add More Items') }}</h4>
                                </div> --}}
                                <div style="text-align: center; margin-top: 3rem;">
                                    <a href="{{ route('index') }}" class="main-btn-six mb-3"
                                            ...
                                            <ul class="">
                                                @if (auth()->user())
                                                    <li class="nav">
                                                        ...
                                                        <label class="form-check-label" style="margin-left: 10px;"
                                                            for="payment_method">
                                                            <img src="{{ asset($cash_payment->cash_image) }}"
                                                                width="30" alt="img">
                                                            Pay With Cash
                                                        </label>
                                                    </li>
                                                ...
                                                <li class="nav mt-2 justify-content-between">
                                                    <div>
                                                        ...
                                                        <label class="form-check-label" style="margin-left: 10px;"
                                                            for="cardPayment">
                                                            <img src="{{ asset($stripe->image) }}" width="30"
                                                                alt="img">
                                                            Pay With Card
                                                        </label>
                                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- <div class="payment-popup__top payment-popup__top--digital">
                            <div class="payment-popup">
                                <div class="payment-popup__inner">
                                    <div class="card p-4" style="width: 100%; border-radius: 15px;">
                                        ...
                                        <form role="form" action="{{ route('pay-with-stripe') }}" method="POST"
                                            ...
                                            <!-- Hidden Fields (matching old form) -->
                                            <input type="hidden" name="type1" value="pickup">
                                            <input type="" name="delevery_time1" id="delevery_time1"
                                                value="">
                                            <input type="hidden" name="delevery_day1" id="delevery_day1"
                                                value="">
                                            <input type="hidden" name="note1" id="note1" value="">
                                            ...
                                            <!-- Card Details Section (matching old form) -->
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                                            <img src="{{ asset('frontend/assets/images/visa-svgrepo-com.svg') }}"
                                                                alt="Visa" class="card-icon" />
                                                        </span>
                                                        <span class="input-group-text">
                                                            <img src="{{ asset('frontend/assets/images/mastercard-svgrepo-com.svg') }}"
                                            ...
                                            <div class="mb-3 d-flex justify-content-between">
                                                ...
                                                <input class="form-control card-expiry-year" type="text"
                                                    name="year" placeholder="{{ __('translate.Year') }}"
                                                    autocomplete="off" required>
                                                <input class="form-control card-cvc card-expiry-year" type="text"
                                                    name="cvc" placeholder="{{ __('translate.CVV') }}"
                                                    autocomplete="off"required>
                                            </div>

                                            <!-- Save Card Checkbox (if necessary) -->
                                            ...
                                            <div class="col-12 error alert alert-danger d-none">
                                                <div class="payment-popup__error">
                                                    {{ __('translate.Please provide your valid card information') }}
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script>
        ...
        $('#delevery_day').on('change', function() {
            ...
            if (selectedDate) {
                $.ajax({
                    url: "{{ route('get.available.slots') }}", // Your backend route
                    type: "GET",
                    data: {
                    ...
                    success: function(response) {
                        ...
                        if (response.length > 0) {
                            ...
                            timeDropdown.append(
                                '<option value="">{{ __('translate.No available slots') }}</option>'
                                );
                        }
                    },
                    error: function() {
                        timeDropdown.html(
                            '<option value="">{{ __('translate.Error loading slots') }}</option>');
                    }
                });
            }
        });
