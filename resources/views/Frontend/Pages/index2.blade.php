                            ...
                            <ul class="shaf-filter course-filter customer-item-slick-row">
                                ...
                                @foreach ($Allcategories as $Allcategory)
                                    <li class="categories-item mx-1 text-center"
                                        ...
                                        <a href="#{{ $Allcategory->name }}" onclick="scrollToElementWithOffset('{{ $Allcategory->name }}')" class="text-dark">
                                            <div class="categories-icon text-center">
                                                <img style="margin: auto" src="{{ asset($Allcategory->image) }}"
                                                    height="80" alt="{{ $Allcategory->name }}">
                                            </div>
