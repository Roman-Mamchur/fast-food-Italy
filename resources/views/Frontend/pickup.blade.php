                                ...
                                <div class="delivery-from">
                                    ...
                                    <div class="row">
                                        <div class="delivery-from-item col-md-6">
                                            ...
                                            <input type="date" name="delevery_day" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="form-control"
                                            ...
                                            <select class="form-select" aria-label="Default select example"
                                                ...
                                                @foreach ($slots as $slot)
                                                    @php
                                                        ...
                                                        $slotTime = \Carbon\Carbon::createFromFormat('h:i A', trim($startTime), 'Europe/Dublin');
                                                    @endphp
                                            ...
                                            @if (!auth()->user())
                                                @if ($stripe->status)
                                                    <div class="shopping-payment-btn" id="stripCard"
                                                        style="display: block;">
                                                        <a href="javascript:;" disabled class="main-btn-six pt-2"
