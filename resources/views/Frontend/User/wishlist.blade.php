                                ...
                                <div class="popular-item-box row-card">
                                    <div class="popular-item-box-img">
                                        ...
                                        <div class="popular-item-box-img-overlay">
                                            <a
                                                href="{{ route('wishlist.removeR', $wishlist->Product['id']) }}">
                                            <div class="icon">
                                                <span>
                                    ...
                                    <div class="popular-inner-box">
                                        ...
                                        data-bs-target="#exampleModal{{ $wishlist->Product['id'] }}">
                                        ...
                                        <div class="popular-inner-item-btm">
                                            <div class="text">
                                                <h3>{{$setting->currency_icon}}{{ number_format($wishlist->Product->price, 2) }}</h3>
                                            </div>
