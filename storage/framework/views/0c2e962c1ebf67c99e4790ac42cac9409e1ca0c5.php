											...
											<div class="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
												...
												<div class="sherah-progress-card__content">
													<div class="sherah-progress-card__heading">
														...
														<h4 class="sherah-progress-card__title"><b class="count-animate"><?php echo e($setting->currency_icon); ?><?php echo e($totalSales); ?></b></h4>
													</div>
											...
											<div class="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
												...
												<div class="sherah-progress-card__content">
													<div class="sherah-progress-card__heading">
														...
														<h4 class="sherah-progress-card__title"><b class="count-animate"><?php echo e($totalOrder); ?></b></h4>
													</div>
													<div class="sherah-progress-card__button">
											...
											<div class="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
												...
												<div class="sherah-progress-card__content">
													<div class="sherah-progress-card__heading">
														...
														<h4 class="sherah-progress-card__title"><b class="count-animate"><?php echo e($totalUser); ?></b></h4>
													</div>
													<div class="sherah-progress-card__button">
											...
											<div class="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
												...
												<div class="sherah-progress-card__content">
													<div class="sherah-progress-card__heading">
														...
														<h4 class="sherah-progress-card__title"><b class="count-animate"><?php echo e($totalProduct); ?></b></h4>
													</div>
													<div class="sherah-progress-card__button">
															...
															<tr>
																<td class="sherah-table__column-1 sherah-table__data-1">
																	<div class="sherah-language-form__input">
																		...
																		<p class="crany-table__product--number"><a href="<?php echo e(route('order.detils',$order->id)); ?>" class="sherah-color1">#<?php echo e($order->id); ?></a></p>
																	</div>
																</td>
																<td class="sherah-table__column-2 sherah-table__data-2">
																	<div class="sherah-table__product-content">
																		<p class="sherah-table__product-desc"><?php echo e($order->type); ?></p>
																	</div>
																</td>
																<td class="sherah-table__column-3 sherah-table__data-3">
																	<div class="sherah-table__product-content">
																		<p class="sherah-table__product-desc"><?php echo e($order->userName->name); ?></p>
																	</div>
																</td>
																<td class="sherah-table__column-4 sherah-table__data-4">
																	<p class="sherah-table__product-desc"><?php echo e($order->created_at->format('M d, Y h:i A')); ?></p>
																</td>
																...
																<td class="sherah-table__column-6 sherah-table__data-6">
																	<div class="sherah-table__product-content">
																		<p class="sherah-table__product-desc"><?php echo e($order->payment_method); ?></p>
																	</div>
																</td>
																<td class="sherah-table__column-7 sherah-table__data-7">
																	<div class="sherah-table__product-content">
																		<p class="sherah-table__product-desc"><?php echo e($setting->currency_icon); ?><?php echo e($order->grand_total); ?></p>
																	</div>
																</td>
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/Dashboard.blade.php ENDPATH**/ ?>