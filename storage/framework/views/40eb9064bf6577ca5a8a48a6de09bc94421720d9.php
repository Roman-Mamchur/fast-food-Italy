																...
																<div class="sherah-accordion accordion accordion-flush sherah__item-group sherah-default-bg sherah-border" id="sherah-accordion">
																	<div class="sherah__item-group sherah-default-bg sherah-border mg-top-30">
																		...
																		<div class="sherah__item-form--group">
																			<form class="sherah-wc__form-main p-0" action="<?php echo e(route('update-google-recaptcha')); ?>" method="POST" enctype= multipart/form-data>
																				<?php echo csrf_field(); ?>
																				<div class="row">
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value = "<?php echo e($googleRecaptcha->site_key); ?>" name="site_key">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value = "<?php echo e($googleRecaptcha->secret_key); ?>" name="secret_key">
																								<div class="sherah-form-icon sherah-color1"></i></div>
																							</div>
																						</div>
																					</div>
																					<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<select name="status">
																									<option  value="1" <?php echo e(( $googleRecaptcha->status == 1) ? 'selected' : ''); ?>>Enable</option>
																									<option  value="0" <?php echo e(( $googleRecaptcha->status == 0) ? 'selected' : ''); ?>>Disable</option>
															...
															<div class="tab-pane fade" id="tawk-chat" role="tabpanel">
																<div class="sherah-accordion accordion accordion-flush sherah__item-group sherah-default-bg sherah-border" id="sherah-accordion">
																	<div class="sherah__item-group sherah-default-bg sherah-border mg-top-30">
																		...
																		<div class="sherah__item-form--group">
																			<form class="sherah-wc__form-main p-0" action="<?php echo e(route('update-tawk.io-live-chat')); ?>" method="POST" enctype= multipart/form-data>
																				<?php echo csrf_field(); ?>
																				<div class="row">
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value = "<?php echo e($tawk_chat->chat_link); ?>" name="chat_link">
																								<div class="sherah-form-icon sherah-color1"></i></div>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<select name="status">
																									<option  value="1" <?php echo e(( $tawk_chat->status == 1) ? 'selected' : ''); ?>>Enable</option>
																									<option  value="0" <?php echo e(( $tawk_chat->status == 0) ? 'selected' : ''); ?>>Disable</option>
															...
															<div class="tab-pane fade" id="google-analytic" role="tabpanel">
																<div class="sherah-accordion accordion accordion-flush sherah__item-group sherah-default-bg sherah-border" id="sherah-accordion">
																	<div class="sherah__item-group sherah-default-bg sherah-border mg-top-30">
																		...
																		<div class="sherah__item-form--group">
																			<form class="sherah-wc__form-main p-0" action="<?php echo e(route('update-google-analytic')); ?>" method="POST" enctype= multipart/form-data>
																				<?php echo csrf_field(); ?>
																				<div class="row">
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value = "<?php echo e($googleAnalytic->analytic_id); ?>" name="analytic_id">
																								<div class="sherah-form-icon sherah-color1"></i></div>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<select name="status">
																									<option  value="1" <?php echo e(( $googleAnalytic->status == 1) ? 'selected' : ''); ?>>Enable</option>
																									<option  value="0" <?php echo e(( $googleAnalytic->status == 0) ? 'selected' : ''); ?>>Disable</option>
															...
															<div class="tab-pane fade show active" id="webSetting" role="tabpanel">
																<div class="sherah-accordion accordion accordion-flush sherah__item-group sherah-default-bg sherah-border" id="sherah-accordion">
																	<div class="sherah__item-group sherah-default-bg sherah-border mg-top-30">
																		...
																		<div class="sherah__item-form--group">
																			<form class="sherah-wc__form-main p-0" action="<?php echo e(route('setting.theam.change',$setting->id)); ?>" method="POST">
																				<?php echo csrf_field(); ?>
																				<div class="row">
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<select name="theam">
                                                                                                    ...
                                                                                                    <option  value="0" <?php echo e(( $setting->theam == 0) ? 'selected' : ''); ?>>Theam-all</option>
                                                                                                                                                                        <option  value="1" <?php echo e(( $setting->theam == 1) ? 'selected' : ''); ?>>Theam-1</option>
																									<option value="2" <?php echo e(( $setting->theam == 2) ? 'selected' : ''); ?>>Theam-2</option>
																								</select>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value = "<?php echo e($setting->app_name); ?>" name="app_name">
																								<div class="sherah-form-icon sherah-color1"></i></div>
																							</div>
																						</div>
																					</div>
																						...
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<select name="app_visibility">
																									<option  value="1" <?php echo e(( $setting->app_visibility == 1) ? 'selected' : ''); ?>>Enable</option>
																									<option value="0" <?php echo e(( $setting->app_visibility == 0) ? 'selected' : ''); ?>>Disable</option>
																								</select>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value = "<?php echo e($setting->currency_name); ?>" name="currency_name">
																								<div class="sherah-form-icon sherah-color1"></i></div>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value = "<?php echo e($setting->currency_icon); ?>" name="currency_icon">
																								<div class="sherah-form-icon sherah-color1"></i></div>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<input class="sherah-wc__form-input" type="text" value="<?php echo e($setting->vat_rate); ?>" name="vat_rate">
																								<div class="sherah-form-icon sherah-color1"></i></div>
																							</div>
																						</div>
																					</div>
																							...
																							<div class="sherah-input-icon">
																								<select name="lang_key">
																									<?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																										<option  value="<?php echo e($language->lang_code); ?>" <?php echo e(( $setting->lang_key == $language->lang_code) ? 'selected' : ''); ?>><?php echo e($language->name); ?></option>
															...
															<div class="tab-pane fade" id="id7" role="tabpanel">
																<div class="sherah-accordion accordion accordion-flush sherah__item-group sherah-default-bg sherah-border" id="sherah-accordion">
																	<div class="sherah__item-group sherah-default-bg sherah-border mg-top-30">
																		...
																		<div class="sherah__item-form--group">
																			<form class="sherah-wc__form-main p-0" action="<?php echo e(route('update.login.page.logo')); ?>" method="POST" enctype="multipart/form-data">
																				<?php echo csrf_field(); ?>
																				<div class="row">
																				<h4 class="sherah-default-bg sherah-border__title">Logo & Favicon</h4>
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<img id="preview-logo" class="sherah-input-icon m-5 setting_logo" src="<?php echo e($setting->logo); ?>" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<img id="preview-logo" class="sherah-input-icon m-5 stiky_logo" src="<?php echo e($setting->stiky_logo); ?>" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<img id="preview-logo" class="sherah-input-icon m-5 favicon" src="<?php echo e($setting->favicon); ?>" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon mt-4">
																								<img  id="preview-bg" class="sherah-input-icon m-5 frondend_logo" src="<?php echo e($setting->frondend_logo); ?>" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon mt-4">
																								<img  id="preview-bg"  class="sherah-input-icon m-5 frondend_login_page" src="<?php echo e(asset($setting->frondend_login_page)); ?>" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon mt-4">
																								<img   id="preview-img"  class="sherah-input-icon m-5 login_page_image" src="<?php echo e($setting->login_page_image); ?>" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon mt-4">
																								<img  id="preview-bg"  class="sherah-input-icon m-5 login_page_bg" src="<?php echo e($setting->login_page_bg); ?>" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
...
<script>
	...
	function changeStatusForDarkMode()
    {
        $.ajax({
            type:"GET",
            data: { _token : '<?php echo e(csrf_token()); ?>' },
            url: "<?php echo e(route('dark.mode.status')); ?>",
            dataType: "json",
            success: function(response){
            }
        });
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/Settings.blade.php ENDPATH**/ ?>