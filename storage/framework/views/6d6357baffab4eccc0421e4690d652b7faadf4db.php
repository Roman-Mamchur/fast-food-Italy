        ...
        <div class="col-lg-6 col-md-6 col-12 sherah-wc-col-two">
            <div class="sherah-wc__form">
                <div class="sherah-wc__form-inner">
                    ...
                    <!-- Sign in Form -->
                    <form class="sherah-wc__form-main p-0" action="<?php echo e(route('admin.orderlogin')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Admin.Auth.MasterLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/Auth/orderLogin.blade.php ENDPATH**/ ?>