									...
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    <th class="sherah-table__column-1 sherah-table__h1">Reservation ID</th>
                                                    <th class="sherah-table__column-9 sherah-table__h9">Date</th>
                                                    <th class="sherah-table__column-3 sherah-table__h3">Time</th>
                                                    <th class="sherah-table__column-4 sherah-table__h4">Details</th>
													...
													<tr>
														<td class="sherah-table__column-1 sherah-table__data-1">
															<div class="sherah-language-form__input">
																<p class="crany-table__product--number">#<?php echo e($order->id); ?></p>
															</div>
														</td>
														<td class="sherah-table__column-3 sherah-table__data-3">
															<p class="sherah-table__product-desc"><?php echo e(\Carbon\Carbon::parse($order->date)->format('M d, Y')); ?></p>
														</td>
														<td class="sherah-table__column-3 sherah-table__data-3">
															<p class="sherah-table__product-desc"><?php echo e(\Carbon\Carbon::parse($order->date)->format('h:i A')); ?></p>
														</td>
														<td class="sherah-table__column-6 sherah-table__data-6">
															<div class="sherah-table__product-content">
																<p class="sherah-table__product-desc"><?php echo e($order->details); ?></p>
															</div>
														</td>
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/pages/order/pre_order.blade.php ENDPATH**/ ?>