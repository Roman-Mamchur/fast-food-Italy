							...
							<div class="sherah-body">
								<div class="sherah-dsinner">
                                            ...
                                            <tbody class="sherah-table__body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">
                                                                <a href="<?php echo e(route('menu-detils',$review->Product->slug)); ?>">
                                                                    <?php echo e($review->Product->slug); ?>
                                                    ...
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($review->user->name); ?></p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-4 sherah-table__data-4">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($review['review']); ?></p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($review['rating'].'star'); ?></p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeStatus(<?php echo e($review->id); ?>)" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeStatus(<?php echo e($review->id); ?>)" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
												  <?php endif; ?>
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            <a href="<?php echo e(route('reviews.delete',$review['id'])); ?>" type="button" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
									...
									<div class="row mg-top-40">
										<?php echo e($reviews->links('Admin.component.pagination')); ?>
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "<?php echo e(route('reviews.change.status', ':Id')); ?>".replace(':Id',Id),
            dataType: "json",
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/Reviews.blade.php ENDPATH**/ ?>