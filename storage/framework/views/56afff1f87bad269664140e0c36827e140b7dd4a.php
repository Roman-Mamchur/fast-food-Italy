...
<?php $__env->startSection('meta'); ?>
    <meta name="title" content="<?php echo e($product->seo_titel); ?>">
    <meta name="description" content="<?php echo e($product->seo_description); ?>">
    <meta name="keywords" content="<?php echo e($product->seo_description); ?>">
<?php $__env->stopSection(); ?>
            ...
            <div class="row  ">
                <div class="col-lg-12">
                    <div class="inner-banner-head">
                        <h1><?php echo e(__('translate.Menu Details')); ?></h1>
                    </div>
                    ...
                    <div class="inner-banner-item">
                        ...
                        <div class="left">
                            <span><?php echo e(__('translate.Menu Details')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="food-details-slick">
                        ...
                        <div class="slider-nav">
                            <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $glry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="slider-nav-img">
                                    <img src="<?php echo e(asset($glry['image'])); ?>" alt="">
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true"><?php echo e(__('translate.Menu Details')); ?></button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-profile" type="button" role="tab"
                                    aria-controls="pills-profile" aria-selected="false"><?php echo e(__('translate.Video')); ?></button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-contact" type="button" role="tab"
                                    aria-controls="pills-contact" aria-selected="false"><?php echo e(__('translate.Review')); ?></button>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="food-details-text all-details-root">
                                            <?php echo clean($product->long_description); ?>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <div class="food-video-text">
                                    <?php echo clean($product->vedio_top_ber_description); ?>

                                </div>

                                <div class="vedio-img">
                                    <img src="<?php echo e(asset($product['vedio_tumb_image'])); ?>" alt="img">

                                    <a class="my-video-links" data-autoplay="true" data-vbtype="video"
                                        href="<?php echo e($product->vedio_url); ?>"><i class="fa-solid fa-play"></i></a>
                                </div>

                                <div class="food-video-text-btm">
                                    <?php echo clean($product->vedio_buttom_description); ?>
                                ...
                                <div class="food-review">
                                    ...
                                    <div class="food-review-item">
                                        <div class="food-review-item-top">
                                            ...
                                            ?>
                                            <div class="text">
                                                <a href="#"><?php echo e($daysAgo .' days ago'); ?></a>
                                            </div>
                                        </div>

                                        <div class="food-review-item-text">
                                            <p>“<?php echo e(html_decode($review->review)); ?>”</p>
                                        </div>
                                ...
                                <div class="sent-review">
                                    <div class="comment-from-box-main">
                                        <div class="comment-from-box-text">
                                            <h3><?php echo e(__('translate.Submit a review')); ?></h3>
                                                ...
                                                <div class="from-item">
                                                    ...
                                                    <div class="from-inner-two  pb-4">
                                                        <textarea class="form-control" name="review" id="reviewText"
                                                            rows="5" placeholder="<?php echo e(__('translate.Write Review')); ?> *" required></textarea>
                                                    </div>
                ...
                <div class="col-lg-4">
                    <form action="<?php echo e(route('cart.add.detils')); ?>" method="POST">
                        ...
                        <div class="together-box">
                            ...
                            <?php $__currentLoopData = json_decode($product->size, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = json_decode($product->items, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="together-box-item">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="addon_<?php echo e($loop->parent->index); ?>_<?php echo e($loop->index); ?>">
                                        <?php echo e($addon->name); ?> (<?php echo e($setting->currency_icon); ?><?php echo e($addon->price); ?>)
                                    </label>
                                </div>
                                <div class="form-check-btn">
                                    <div class="form-check-btn">
                                        ...
                                        <div class="grid">
                                            <button class="btn btn-minus" data-addon-index="<?php echo e($loop->parent->index); ?>_<?php echo e($loop->index); ?>"><i class="fa-solid fa-minus"></i></button>
                                            <div class="column product-qty" id="quantityUpdate_<?php echo e($loop->parent->index); ?>_<?php echo e($loop->index); ?>">0</div>
                                            <input type="hidden" name="addons_qty[]" id="qtyInput_<?php echo e($loop->parent->index); ?>_<?php echo e($loop->index); ?>" value="1">
                                            <button class="btn btn-plus" data-addon-index="<?php echo e($loop->parent->index); ?>_<?php echo e($loop->index); ?>"><i class="fa-solid fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('Frontend.Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Frontend/Pages/manu_detils.blade.php ENDPATH**/ ?>