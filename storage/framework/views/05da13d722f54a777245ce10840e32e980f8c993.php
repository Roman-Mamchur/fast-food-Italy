							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									...
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="<?php echo e(route('product.store')); ?>" method="POST" enctype= multipart/form-data >
                                        <?php echo csrf_field(); ?>
                                            <div class="row">
                                                <div class="col-12">
                                                    <!-- Product Info -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" value="<?php echo e(old('name')); ?>" placeholder="Type here" type="text" id="name" name="name" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <input class="sherah-wc__form-input" value="<?php echo e(old('slug')); ?>" placeholder="Type here" type="text" name="slug" id="slug" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-group__input" aria-label="Default select example" name="category_id" required>
                                                                        ...
                                                                        <option value ="<?php echo e($categorie->id); ?>"><?php echo e($categorie->translate_category?->name); ?></option>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="sherah-wc__form-input" value="<?php echo e(old('price')); ?>" required placeholder="Type here" type="number" name="main_price" step="0.1">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="sherah-wc__form-input" value="<?php echo e(old('position')); ?>" placeholder="Type here" type="position" name="position" id="position">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="description" row="8" placeholder="Type here" type="text" name="long_description"><?php echo e(old('long_description')); ?></textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="special_instructions" row="5" placeholder="Special Instructions" type="text" name="special instructions"><?php echo e(old('long_description')); ?></textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="sherah-wc__form-input" value="<?php echo e(old('seo_titel')); ?>" placeholder="Type here" type="text" name="seo_titel" id="seo_titel">
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Seo Description *</label>
                                                                    <textarea class="sherah-wc__form-input" value="<?php echo e(old('seo_description')); ?>" id="description" row="5" placeholder="type here" type="text" name="seo_description"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <div class="checkbox-group__single">
                                                                                <input type="checkbox" value="<?php echo e($item->id); ?>" class="btn-check" name="items[]" id="option1<?php echo e($index); ?>">
                                                                                <label class="checkbox-group__single--label" for="option1<?php echo e($index); ?>"><?php echo e($item->translate_item?->name); ?></label>
                                                                            </div>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            <div class="image-upload-group__single">
                                                                                <img <?php if(true): echo 'required'; endif; ?> id="preview-img" src="">
                                                                            </div>
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <table class="table table-bordered table-hover" id="dynamic_field">
                                                                            <tr>
                                                                              ...
                                                                              <td>
                                                                                <input type="number" name="price[]" placeholder="Enter Price" class="form-control name_email" step="0.1"/>
                                                                              </td>
...
<script>
 ...
 $(document).ready(function(){
   var i = 1;
   $("#add").click(function(){
       $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="size[]" placeholder="Enter Size" class="form-control name_list"/></td><td><input type="number" name="price[]" placeholder="Enter Price" class="form-control name_email" step="0.1" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
     });
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/pages/product/create.blade.php ENDPATH**/ ?>