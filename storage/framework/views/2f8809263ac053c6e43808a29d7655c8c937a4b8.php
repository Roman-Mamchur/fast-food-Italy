...
<html class="no-js" lang="zxx">
	<head>
		...
		<link rel="stylesheet" href="<?php echo e(asset('cdn/select2.min.css')); ?>"  />
		<link rel="stylesheet" href="<?php echo e(asset('admin/style.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('cdn/toastr.min.css')); ?>"/>
		<link rel="stylesheet" href="<?php echo e(asset('admin/css/bootstrapicons-iconpicker.css')); ?>" >
...
<?php /**PATH /Applications/XAMPP/htdocs/food/resources/views/Admin/Base/Header.blade.php ENDPATH**/ ?>