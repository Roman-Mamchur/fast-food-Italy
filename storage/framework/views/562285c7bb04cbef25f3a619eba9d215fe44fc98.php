                                            ...
                                            <tr>
                                                <td class="sherah-table__column-1 sherah-table__data-1">
                                                    <div class="sherah-table__product">
                                                        <h4 class="sherah-table__vendor--title"><a href="javascript:;"><?php echo e(html_decode($customer['name'])); ?></a></h4>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><?php echo e(html_decode($customer['email'])); ?></p>
                                                    </div>
                                                </td>
                                               <?php if($customer['phone']): ?>
                                               <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><?php echo e(html_decode($customer['phone'])); ?></p>
                                                    </div>
                                                </td>
                                                <?php else: ?>
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                ...
                                                <td class="sherah-table__column-6 sherah-table__data-6">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><?php echo e($customer['created_at']->toDateString()); ?></p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__status__group">
                                                        <a href="<?php echo e(route('detils.customer',$customer->id)); ?>" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                        ...
                                                        <a href="<?php echo e(route('admin.delete.pending.user',$customer->id)); ?>" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/Customers.blade.php ENDPATH**/ ?>