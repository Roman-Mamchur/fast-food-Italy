                                    ...
                                    <div class="sherah-header__right">
                                        ...
                                        <div class="sherah-header__author sherah-flex__center--top">
                                            <div class="sherah-header__author-img">
                                                <img src="<?php echo e(asset(Auth::guard('admin')->user()->image)); ?>" alt="#">
                                            </div>
                                            <div class="sherah-header__author--info sherah-dflex sherah-dflex__base">
                                                <h4 class="sherah-header__author--title  sherah-dflex sherah-dflex__column"><?php echo e(Auth::guard('admin')->user()->name); ?>

                                                     <?php if(Auth::guard('admin')->user()->admin_type ==1 ): ?>
                                                ...
                                                <ul class="sherah-dropdown-card_list">
                                                    <li>
                                                        <div class="sherah-dropdown-card-info">
                                                            ...
                                                            <h4 class="sherah-dropdown-card-name"><a href="<?php echo e(route('AdminProfile.index')); ?>">My Profile</a></h4>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="sherah-dropdown-card-info">
                                                            ...
                                                            <h4 class="sherah-dropdown-card-name"><a href="<?php echo e(route('admin.logout')); ?>">Logout</a></h4>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/Base/Navbar.blade.php ENDPATH**/ ?>