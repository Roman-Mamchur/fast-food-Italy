            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="nav-main">
                        <div class="nav-main">
                            <div class="logo">
                                <a href="<?php echo e(route('index')); ?>"> <img width="80" src="<?php echo e(asset('frontend/assets/images/logo/logo-header.png')); ?>"
                                        alt="logo"></a>
                            </div>
                            ...
                            <div class="menu">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('contact')); ?>"><?php echo e(__('Reservation')); ?></a></li>
                        ...
                        <div class="nav-btn-main">
                            ...
                            <?php if(!Auth::user()): ?>
                                <div class="nav-login-btn-main">
                                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModalLogin" class="main-btn-four custom-btn"><?php echo e(__('Log In')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="mobile-header__container">
                <div class="p-left d-flex">
                    ...
                    <div style="text-align: center; margin-left: 30px;">
                        ...
                        href="tel:<?php echo e($section->top_ber_phone); ?>"><i class="fa fa-phone"></i><?php echo e($section->top_ber_phone); ?></a>
...
<aside id="offcanvas-nav">
    <nav class="m-nav">
        ...
        <div class="logo">
            <a href="<?php echo e(route('index')); ?>">
                <img src="<?php echo e(asset('frontend/assets/images/logo/logo-header.png')); ?> height="70" alt="logo">
            </a>
        </div>
        <ul class="nav-links">
            <li><a href="<?php echo e(route('index')); ?>"><?php echo e(__('translate.Home')); ?></a></li>
            ...
            <li><a href="<?php echo e(route('about')); ?>"><?php echo e(__('translate.About Us')); ?></a></li>
            <li><a href="<?php echo e(route('contact')); ?>"><?php echo e(__('Reservation')); ?></a></li>
            <li><a href="<?php echo e(route('blog')); ?>"><?php echo e(__('translate.Blog')); ?></a></li>
        </ul>

    </nav>
</aside>
<!-- header part end  -->
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Frontend/Layouts/Partials/header.blade.php ENDPATH**/ ?>