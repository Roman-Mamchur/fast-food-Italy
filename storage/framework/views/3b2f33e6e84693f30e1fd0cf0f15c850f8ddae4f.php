    ...
    <div class="dashboard-menu">
        <div class="dashboard-menu-profile-main">
            <div class="dashboard-menu-profile">
                ...
                <div class="dashboard-menu-profile-text">
                    <h4><?php echo e(html_decode(Auth::user()->name)); ?></h4>
        ...
        <div class="dashboard-menu-main">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo e(route('user.edit.profile')); ?>" class="<?php echo e(request()->is('user/edit-profile') ? 'active' : ''); ?>">
                        <span>
                        ...
                        <?php echo e(__('translate.Edit Profile')); ?>

                    </a>
                </li>
                
                <li>
                    <a href="<?php echo e(route('user.order')); ?>" class="<?php echo e(request()->is('user/order') ? 'active' : ''); ?>">
                        <span>
                        ...
                        <?php echo e(__('translate.My Orders')); ?>

                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('user.wishlist')); ?>" class="<?php echo e(request()->is('user/wishlist') ? 'active' : ''); ?>">
                        <span>
                ...
                <li>
                    <a href="<?php echo e(route('user.card.index')); ?>" class="<?php echo e(request()->is('user/change-password') ? 'active' : ''); ?>">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="4" width="20" height="16" rx="2" stroke="black" stroke-width="2"/>
                                <line x1="2" y1="10" x2="22" y2="10" stroke="black" stroke-width="2"/>
                ...
                <li>
                    <a href="<?php echo e(route('user.change.password')); ?>" class="<?php echo e(request()->is('user/change-password') ? 'active' : ''); ?>">
                        <span>
                        ...
                        <?php echo e(__('translate.Change Password')); ?>
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Frontend/User/sideber.blade.php ENDPATH**/ ?>