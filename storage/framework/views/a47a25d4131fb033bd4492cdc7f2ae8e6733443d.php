							...
							<div class="sherah-body">
								<div class="sherah-dsinner">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($subscriber['email']); ?></p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            <a href="<?php echo e(route('subscriber.delete',$subscriber['id'])); ?>" type="button" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
									...
									<div class="row mg-top-40">
										<?php echo e($subscribers->links('Admin.component.pagination')); ?>
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "<?php echo e(route('subscriber.change.status', ':Id')); ?>".replace(':Id',Id),
            dataType: "json",
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/Subscriber.blade.php ENDPATH**/ ?>