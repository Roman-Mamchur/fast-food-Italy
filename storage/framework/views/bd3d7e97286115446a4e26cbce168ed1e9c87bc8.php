                        ...
                        <div class="col-lg-6 col-md-6 ">
                                ...
                                <div class="delivery-from">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="delivery-from-item col-md-6">
                                            <label for="delevery_day" class="form-label"><?php echo e(__('translate.Select Day')); ?> <span class="text-danger">*</span></label>
                                            <input type="date" name="delevery_day" value="<?php echo e($minDate); ?>" class="form-control" id="delevery_day" required min="<?php echo e($minDate); ?>">
                                        </div>
                                        
                                        <div class="delivery-from-item col-md-6">
                                            <label for="delevery_time" class="form-label"><?php echo e(__('translate.Select Time Schedule')); ?> <span class="text-danger">*</span></label>
                                        
                                            <?php
                                                use Carbon\Carbon;
                                                $currentDate = Carbon::now('Europe/Dublin')->format('Y-m-d');
                                                $currentTime = Carbon::now('Europe/Dublin')->format('h:i A'); // 24-hour format
                                                $isDisabled = ($currentTime >= '23:00' && request('delevery_day') == $currentDate); // Disable if it's 11:00 PM or later and date is today
                                            ?>
                                        
                                            <select class="form-select" aria-label="Default select example"
                                                name="delevery_time" id="delevery_time" required <?php echo e($isDisabled ? 'disabled' : ''); ?>>
                                            ...
                                            <p class="text-danger timeErr" style="display: none;">Please Select delivery time</p>
                                        </div>                                      
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="delivery-from">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="sign-up-from-inner">
                                            <label for="name" class="form-label"><?php echo e(__('translate.Name')); ?><span class="text-danger">*</span></label>
                                ...
                                <div class="delivery-text pb-3 text-center mt-5">
                                    <h4><?php echo e(__('Carving More? Just Add More Items')); ?></h4>
                                </div>
                                <div>
                                    <a href="<?php echo e(route('index')); ?>" class="main-btn-six mb-3">Add More Items</a>
                                </div>
                                ...
                                <div class="apply-coupon">
                                    ...
                                    <div class="apply-coupon-box">
                                                ...
                                                <?php if(auth()->user()): ?>
                                                    <li class="nav">
                                                        ...
                                                        <label class="form-check-label" style="margin-left: 10px;"
                                                            for="payment_method">
                                                            <img src="<?php echo e(asset($cash_payment->cash_image)); ?>" width="30"
                                                                alt="img">
                                                            Pay With Cash
                                                        </label>
                                                    </li>
                                                ...
                                                <li class="nav mt-2 justify-content-between">
                                                    <div>
                                                        <input type="radio" name="payment_method" class="form-check-input"
                                                            value="pay_with_cash" id="cardPayment" required checked
                                                            <?php if(!auth()->user()): ?> checked <?php endif; ?>>
                                                        <label class="form-check-label" style="margin-left: 10px;" for="cardPayment">
                                                            <img src="<?php echo e(asset($stripe->image)); ?>" width="30" alt="img">
                                                            Pay With Card
                                                        </label>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="shopping-cart-list-btn">
                                            <p class="text-danger timeError" style="display: none;">Please Fill and Select required fields</p>
                                            <?php if(!auth()->user()): ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if(Auth::user()): ?>
                                                <button type="submit" style="display: none;" id="cashPay" class="main-btn-six hidePlace">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="text-left">
                            <li>
                                <a href="javascript:;" class="main-btn-three" id="exampleCard">Add New Card</a>
                            </li>
                        </ul>
                        <div class="payment-popup__top payment-popup__top--digital" style="display: none;">
        ...
        $('#delevery_day').on('change', function () {
            ...
            if (selectedDate) {
                $.ajax({
                    ...
                    type: "GET",
                    data: { delevery_day: selectedDate },
                    beforeSend: function () {
                        timeDropdown.html('<option>Loading...</option>'); // Show loading state
                    },
                    success: function (response) {
                        timeDropdown.empty().append('<option value=""><?php echo e(__('translate.Select')); ?></option>');

                        if (response.length > 0) {
                            response.forEach(slot => {
                                timeDropdown.append(`<option value="${slot.id}">${slot.slot}</option>`);
                            });
                        } else {
                            timeDropdown.append('<option value=""><?php echo e(__('translate.No available slots')); ?></option>');
                        }
                    },
                    error: function () {
                        timeDropdown.html('<option value=""><?php echo e(__('translate.Error loading slots')); ?></option>');
                    }
                });
            }
        });
...
<?php echo $__env->make('Frontend.Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Frontend/Pages/pickup.blade.php ENDPATH**/ ?>