            ...
            <div class="row  ">
                <div class="col-lg-12">
                    ...
                    <div class="inner-banner-item">
                        ...
                        <div class="left">
                            <span><?php echo e(__('translate.Dashboard')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-4  d-md-none d-lg-block" data-aos="fade-left">
                            <div class="dashboard-item">
                                <div class="dashboard-item-inner">
                                    ...
                                    <div class="dashboard-item-text">
                                    <h3><?php echo e($totalOrderComplte); ?></h3>
                                        <p><?php echo e(__('translate.Delivery Completed')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6" data-aos="fade-left">
                            <div class="dashboard-item">
                                <div class="dashboard-item-inner">
                                    ...
                                    <div class="dashboard-item-text">
                                        <h3><?php echo e($totalOrderNew); ?></h3>
                                        <p><?php echo e(__('translate.New Order')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('Frontend.Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Frontend/User/dashboard.blade.php ENDPATH**/ ?>