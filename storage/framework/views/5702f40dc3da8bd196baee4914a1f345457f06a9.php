																					...
																					<div class="sherah__item-group sherah-default-bg sherah-border">
																						...
																						<div class="sherah-profile-cover sherah-offset-bg sherah-dflex">
																							<div class="sherah-profile-cover__img">
																								<img src="<?php echo e(asset($admin->image)); ?>" alt="#">
																							</div>
																							<div class="sherah-profile-cover__content">
																								<h3 class="sherah-profile-cover__title"><?php echo e($admin->name); ?></h3>
																								<span class="sherah-profile-cover__text sherah-color1"><?php echo e($admin->bio); ?></span>

																							</div>
																							<div class="sherah-userprofile__right">
																							<a data-id="<?php echo e($setting->id); ?>" data-bs-toggle="modal" data-bs-target="#ProfileEditTable" class="sherah-btn sherah-btn__white ProfileEdit"><svg class="sherah-color3__fill" xmlns="http://www.w3.org/2000/svg" width="18.29" height="18.252" viewBox="0 0 18.29 18.252">
																						...
																						<div class="sherah-profile-info__v2 mg-top-30">
																							...
																							<ul class="sherah-profile-info__list sherah-dflex-column">
																								<li class="sherah-dflex">
																									...
																									<p class="sherah-profile-info__text"><?php echo e($admin->name); ?></p>
																								</li>
																								<li class="sherah-dflex">
																									<h4 class="sherah-profile-info__title">Email :</h4>
																									<p class="sherah-profile-info__text"><?php echo e($admin->email); ?></p>
																								</li>
																								<li class="sherah-dflex">
																									<h4 class="sherah-profile-info__title">Joining Date :</h4>
																									<p class="sherah-profile-info__text"><?php echo e($admin->created_at->toDateString()); ?></p>
																								</li>
																								<li class="sherah-dflex">
																...
																<div class="sherah-paymentm sherah__item-group sherah-default-bg sherah-border ">
																	...
																	<div class="row">
																		<div class="col-xxl-8  col-lg-6 col-md-6 col-12">
																			<!-- Sign in Form -->
																			<form class="sherah-wc__form-main sherah-form-main--v2 p-0" action="<?php echo e(route('admin.chnage.password')); ?>" method="post">
																				<?php echo csrf_field(); ?>
...
<div class="modal fade bd-example-modal-lg" id="ProfileEditTable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="sherah-wc__form-main" action="<?php echo e(route('admin.update.profile',$admin->id)); ?>" method="POST" enctype= "multipart/form-data" >
                <?php echo csrf_field(); ?>
            <div class="variant">
                    <div class="row">
                                ...
                                <div class="row">
									<div class="col-12" id="variant_name">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group__input">
                                                <img class="admin_avatar" id="preview-img-profile" src="<?php echo e(asset($admin->image)); ?>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12" id="item_name">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group__input">
                                                <input class="sherah-wc__form-input"  type="text" name="name" value="<?php echo e($admin->name); ?>" required>
                                            </div>
                                        </div>
                                    </div>
									<div class="col-lg-6 col-12" id="item_name">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group__input">
                                                <input class="sherah-wc__form-input"  type="text" name="email" value="<?php echo e($admin->email); ?>" required>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/AdminProfile.blade.php ENDPATH**/ ?>