...
<body>
        ...
        <ul class="mobile-bottom-menu" >
             <li>
                ...
                <li>
                    ...
                    <div class="tag-count">
                       <span id="carCountM" data-name="cart-dropdown"> <?php echo e(session('cart') ? count(session('cart')) : 0); ?></span>
                    </div>
                ...
                <li>
                    ...
                    <?php else: ?>
                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModalLogin" class="<?php echo e(Route::is('user.wishlist') ? 'active' : ''); ?>">
                    <?php endif; ?>
                ...
                <?php else: ?>
                <a href="javascript:;"
                data-bs-toggle="modal" data-bs-target="#exampleModalLogin" class="<?php echo e(Route::is('user.dashboard') ? 'active' : ''); ?>">
                <i class="fa-solid fa-circle-user"></i>
                <?php endif; ?>
                <?php echo e(__('Login')); ?>
    ...
    <div class="cart-dropdown header-dropdown" id="cart-dropdown">
        ...
        <div class="cart-dropdown-sub-total" id="hasCart"
            <?php if($cartCount == 0): ?> style="display:none;" <?php else: ?> style="display:block;" <?php endif; ?>>
        ...
        <div class="card-body" id="cartBody"
            ...
            <a href="<?php echo e(route('menu')); ?>"
                class="btn btn-primary"><?php echo e(__('translate.Shop Now')); ?></a>
        </div>
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Frontend/Layouts/master.blade.php ENDPATH**/ ?>