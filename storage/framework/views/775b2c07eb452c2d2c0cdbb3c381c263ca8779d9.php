								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="<?php echo e(route('product.create')); ?>" class="sherah-btn sherah-gbcolor">Create Product</a>
                                        </div>
                                    </div>
                                            ...
                                            <tbody class="sherah-table__body">
                                                ...
                                                <tr>
													...
													<td class="sherah-table__column-1 sherah-table__data-6">
														<div class="">
                                                            <img class="product_list_thumb"  src="<?php echo e(asset($product['tumb_image'])); ?>" alt="#">
                                                        </div>
                                                    </td>

                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($product->translate_product?->name); ?></p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($product->price); ?></p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																  <input id="status" onclick="changeCategoryStatus(<?php echo e($product->id); ?>)" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeCategoryStatus(<?php echo e($product->id); ?>)" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
												  <?php endif; ?>
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="<?php echo e(route('product.edit',$product->id)); ?>"  class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                            ...
                                                            <a href="<?php echo e(route('product.destroy',$product->id)); ?>" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
                                                            ...
                                                            <a href="<?php echo e(route('product.gallery',$product->id)); ?>" class="sherah-table__action sherah-color2 sherah-color1__bg--offset blog_comment_delete">
...
<script>
    ...
    $.ajax({
        ...
        url: "<?php echo e(route('product.item.status.change', ':catId')); ?>".replace(':catId',Id),
        dataType: "json",
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/pages/product/index.blade.php ENDPATH**/ ?>