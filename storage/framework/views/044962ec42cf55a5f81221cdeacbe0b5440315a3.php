            ...
            <div class="row  ">
                <div class="col-lg-12">
                    <div class="inner-banner-head">
                        <h1><?php echo e(__('translate.Our Blogs')); ?></h1>
                    </div>
                    ...
                    <div class="inner-banner-item">
                        ...
                        <div class="left">
                            <span><?php echo e(__('translate.Our Blogs')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <?php $__empty_1 = true; $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-md-6 blog-mt-25px " >
                        <div class="news-item">
                            <div class="news-img">
                                <img src="<?php echo e(asset($blog['image'])); ?>" class="w-100" alt="img">

                                <div class="news-img-overlay">
                                    <div class="news-img-overlay-text">
                                        <h5><?php echo e($blog->tag); ?> <span>•</span> </h5>

                                        <h3><a href="<?php echo e(route('blog-detils',$blog->slug)); ?>"><?php echo e($blog->title); ?></a></h3>
                                    </div>

                                    <div class="news-img-overlay-btn">
                                        <a href="<?php echo e(route('blog-detils',$blog->slug)); ?>"><?php echo e(__('translate.Read More')); ?> <span>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-12 blog-mt-25px text-center cart_empty_area" >
                        ...
                        <h3 class="sorry-text"><?php echo e(__('translate.Sorry!! Blog not found.')); ?></h3>
                        <p class="mb-4"><?php echo e(__('translate.Whoops... this information is not available for a moment')); ?></p>
                        <a class="main-btn-four" href="<?php echo e(route('blog')); ?>"><span><?php echo e(__('translate.Back to Blog')); ?></span></a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('Frontend.Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Frontend/Pages/blog.blade.php ENDPATH**/ ?>