								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="<?php echo e(route('deliveryarea.create')); ?>" class="sherah-btn sherah-gbcolor">Create Delivery Area</a>
                                        </div>
                                    </div>
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <tbody class="sherah-table__body">
												<?php $__currentLoopData = $delivery_areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>

													<td class="sherah-table__column-1 sherah-table__data-1">
                                                        <div class="sherah-language-form__input">
                                                            <p class="crany-table__product--number"><a href="#" class="sherah-color1"><?php echo e(++$index); ?></a></p>
                                                        </div>
                                                    </td>
													<td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($area->area_name); ?></p>
														</div>
                                                    </td>
													<td class="sherah-table__column-3 sherah-table__data-3">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($area->min_time); ?> - <?php echo e($area->max_time); ?> <?php echo e('Minutes'); ?></p>
														</div>
                                                    </td>
													<td class="sherah-table__column-4 sherah-table__data-4">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc"><?php echo e($setting->currency_name); ?><?php echo e($area->fee); ?></p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																  <input id="status" onclick="changeCategoryStatus(<?php echo e($area->id); ?>)" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeCategoryStatus(<?php echo e($area->id); ?>)" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
												  <?php endif; ?>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="<?php echo e(route('deliveryarea.edit',$area->id)); ?>"  class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                            ...
                                                            <a href="<?php echo e(route('deliveryarea.delete',$area->id)); ?>" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
...
<script>
    ...
    $.ajax({
        ...
        url: "<?php echo e(route('deliveryarea.change.status', ':catId')); ?>".replace(':catId',Id),
        dataType: "json",
...
<?php /**PATH /home/u811877689/domains/midwaykebabish.ie/public_html/resources/views/Admin/pages/delivery_area/index.blade.php ENDPATH**/ ?>